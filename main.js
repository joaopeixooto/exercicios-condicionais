...
if (idade >= 16 && idade < 60) {
        ...
        if (minutos > 0) {
            if (distancia == 5 || distancia == 10){
                ...
                if (pace >= 8.5 ) {
                    ...
                    alert("Você se classificou como Elite na prova de longa distância!")
                    var competir = prompt("Você deseja participar da competição? responda sim ou não:")
                    if (competir == "sim") {
                        alert("Certo, você vai competir.")
                    } else {
    ...
    alert("É necessário apresentar um atestado médico para participar!")
    ...
    alert("Infelizmente você não pode se inscrever. A idade mínima é 16 anos.")
} else if (isNaN(idade)) {
